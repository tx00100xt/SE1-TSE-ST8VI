...
struct WeaponInfo _awiWeapons[18] = {
  ...
  { WEAPON_PIPEBOMB,        &_toWPipeBomb,        &_aaiAmmo[3], FALSE },   // 16
//{ WEAPON_GHOSTBUSTER,     &_toWGhostBuster,     &_aaiAmmo[5], FALSE },   // 17
//{ WEAPON_NUKECANNON,      &_toWNukeCannon,      &_aaiAmmo[7], FALSE },   // 18
//{ WEAPON_NONE,            NULL,                 NULL,         FALSE },   // 19
};
