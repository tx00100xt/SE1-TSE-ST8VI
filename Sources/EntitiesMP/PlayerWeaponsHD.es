...
enum WeaponType {
 ...
 16 WEAPON_PIPEBOMB           "",
 17 WEAPON_LAST               "",
}; // see 'WEAPONS_ALLAVAILABLEMASK' -> (11111111111111 == 0x7FFF)


%{
// AVAILABLE WEAPON MASK
#define WEAPONS_ALLAVAILABLEMASK 0xFFFF
...
// ************** SNIPER **************
123 model   MODEL_SNIPER                "ModelsMP\\Weapons\\Sniper\\Sniper.mdl",
124 model   MODEL_SNIPER_BODY           "ModelsMP\\Weapons\\Sniper\\Body.mdl",
125 texture TEXTURE_SNIPER_BODY         "ModelsMP\\Weapons\\Sniper\\Body.tex",
126 sound   SOUND_SNIPER_FIRE           "ModelsMP\\Weapons\\Sniper\\Sounds\\Fire.wav",
//127 sound   SOUND_SNIPER_RELOAD         "ModelsMP\\Weapons\\Sniper\\Sounds\\Reload.wav",
//128 sound   SOUND_SNIPER_ZOOM           "ModelsMP\\Weapons\\Sniper\\Sounds\\Zoom.wav",
...
// ************** GHOSTBUSTER **************
180 model   MODEL_GHOSTBUSTER           "Models\\Weapons\\GhostBuster\\GhostBuster.mdl",
181 model   MODEL_GB_BODY               "Models\\Weapons\\GhostBuster\\Body.mdl",
182 model   MODEL_GB_ROTATOR            "Models\\Weapons\\GhostBuster\\Rotator.mdl",
183 model   MODEL_GB_EFFECT1            "Models\\Weapons\\GhostBuster\\Effect01.mdl",
184 model   MODEL_GB_EFFECT1FLARE       "Models\\Weapons\\GhostBuster\\EffectFlare01.mdl",
185 texture TEXTURE_GB_ROTATOR          "Models\\Weapons\\GhostBuster\\Rotator.tex",
186 texture TEXTURE_GB_BODY             "Models\\Weapons\\GhostBuster\\Body.tex",
187 texture TEXTURE_GB_LIGHTNING        "Models\\Weapons\\GhostBuster\\Lightning.tex",
188 texture TEXTURE_GB_FLARE            "Models\\Weapons\\GhostBuster\\EffectFlare.tex",
189 sound   SOUND_GB_FIRE               "Models\\Weapons\\GhostBuster\\Sounds\\_Fire.wav",
    ...
    */
    ...
    switch (wit) {
      ...
      case WIT_GRENADELAUNCHER: 
        ...
        break;
    case WIT_PIPEBOMB:
		((CPlayer&)*m_penPlayer).ItemPicked(TRANS("XLL PipeBomb"), 0);
      ...
      case WIT_GHOSTBUSTER:
	    ((CPlayer&)*m_penPlayer).ItemPicked(TRANS("GhostBuster"), 0);     
...
//      m_iNukeBalls += (INDEX) (MAX_NUKEBALLS*GetSP()->sp_fAmmoQuantity);
  ...
  WeaponType GetStrongerWeapon(INDEX iWeapon) {
    switch(iWeapon) {
	  ...
	  case 9: return WEAPON_GHOSTBUSTER;
    }
    return WEAPON_NONE;
  };
  ...
  INDEX GetSelectedWeapon(WeaponType EwtSelectedWeapon) {
    switch(EwtSelectedWeapon) {
	  ...
	  case WEAPON_GHOSTBUSTER: return 9;	  
    }
    return 0;
  };
  ...
  WeaponType GetAltWeapon(WeaponType EwtWeapon) {
    switch (EwtWeapon) {
	  ...
	  case WEAPON_GHOSTBUSTER: return WEAPON_GHOSTBUSTER;	  
    }
    return WEAPON_NONE;
  };
  ...
  void SelectNewWeapon() 
  {
    switch (m_iCurrentWeapon) {
      ...
      case WEAPON_GRENADELAUNCHER:
        ...
        WeaponSelectOk(WEAPON_KNIFE);
        break;
      case WEAPON_LASER:  case WEAPON_FLAMER:  case WEAPON_CHAINSAW:   case WEAPON_GHOSTBUSTER:
  ...
  BOOL HasAmmo(WeaponType EwtWeapon) {
    switch (EwtWeapon) {
	  ...
	  case WEAPON_PIPEBOMB: return (m_iGrenades>0);
    }
    return FALSE;
  };
...
//###########################################################################################################
	 ...
	 _st8_fSingleShotgunFireSpeed = Clamp(_st8_fSingleShotgunFireSpeed, (float)1.0f, (float)10.0f);
	  autowait(GetSP()->sp_bCooperative ? 0.5f/_st8_fSingleShotgunFireSpeed : 0.375f);
//###########################################################################################################
//###########################################################################################################
//###########################################################################################################	  
	  /* drop shell */
